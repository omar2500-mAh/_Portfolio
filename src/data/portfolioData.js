...
* 2. Every external link opens in a new tab. Leave a link "" to hide its button.
* 3. For images:
* ```
     - Put image files in: public/assets/images/
  ```
* ```
     - Use: imagePath("image-name.jpg")
  ```
*
...
// Current uploaded file name: profile.jpg.jpg
...
email: "[omar.faruque@example.com](mailto:omar.faruque@example.com)",
formRecipient: "[omar.faruque@example.com](mailto:omar.faruque@example.com)",
};
